...
class ConnectorModelServiceTest : ModelServiceTest<ConnectorEntity, ConnectorModel>() {
    ...
    override fun compareEntityAndAbstractModelAndThrow(entity: ConnectorEntity, model: NamedModel) {
    ...
    override fun compareEntityAndModelAndThrow(entity: ConnectorEntity, model: ConnectorModel) {
