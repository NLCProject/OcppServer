...
class SampledValueModelServiceTest : ModelServiceTest<SampledValueEntity, SampledValueModel>() {
    ...
    override fun compareEntityAndAbstractModelAndThrow(entity: SampledValueEntity, model: NamedModel) {
    ...
    override fun compareEntityAndModelAndThrow(entity: SampledValueEntity, model: SampledValueModel) {
