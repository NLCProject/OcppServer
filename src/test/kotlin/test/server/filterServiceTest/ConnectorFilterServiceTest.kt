...
class ConnectorFilterServiceTest : FilterServiceTest<ConnectorEntity>() {

    @Autowired
    private lateinit var repositoryService: ConnectorRepository

    @Autowired
    private lateinit var filterService: ConnectorFilterService
    ...
    override fun findAllHints(entities: List<ConnectorEntity>) {
